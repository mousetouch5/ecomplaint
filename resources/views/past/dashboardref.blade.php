<x-app-layout>
    <div class="flex h-screen">
        ...
        <div class="modal" id="complaint-modal">
            <div class="modal-box border-2 border-purple-700"> <!-- Added border -->
                <h3 class="font-bold text-lg mb-4 text-purple-700 text-center">Complainant Information</h3> <!-- Purple text -->
                <form id="complaint-info-form" onsubmit="openComplaintDetailModal(event)"> <!-- Handle form submission -->
                    <!-- Input fields -->
                    <div class="mb-4">
                        <label class="block mb-1 text-purple-700">First Name</label>
                        <input type="text" placeholder="Enter First Name" class="input input-bordered w-full border-purple-700" />
                    </div>
                
                    <div class="mb-4">
                        <label class="block mb-1 text-purple-700">Middle Name</label>
                        <input type="text" placeholder="Enter Middle Name" class="input input-bordered w-full border-purple-700" />
                    </div>
                
                    <div class="mb-4">
                        <label class="block mb-1 text-purple-700">Last Name</label>
                        <input type="text" placeholder="Enter Last Name" class="input input-bordered w-full border-purple-700" />
                    </div>
                
                    <div class="mb-4">
                        <label class="block mb-1 text-purple-700">Complete Address</label>
                        <input type="text" placeholder="Enter Address" class="input input-bordered w-full border-purple-700" />
                    </div>
                
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        <div>
                            <label class="block mb-1 text-purple-700">Age</label>
                            <input type="number" placeholder="Enter Age" class="input input-bordered w-full border-purple-700" />
                        </div>
                        <div>
                            <label class="block mb-1 text-purple-700">Sex</label>
                            <select class="select select-bordered w-full border-purple-700">
                    ...
                    <div class="modal-action flex flex-col space-y-2">
                        <button type="button" onclick="openComplaintDetailModal()" class="btn btn-purple-700 text-white bg-purple-700 hover:bg-purple-800 w-full">Submit</button> <!-- Open second modal -->
                    </div>
                </form>
                
                        
                        <!-- 2nd modal boss Complaint Detail Modal -->
                <div class="modal modal-open" id="complaint-detail-modal" style="display: none;"> <!-- Initially hidden -->
                    <div class="modal-box border-2 border-purple-700">
                        ...
                        <form id="complaint-detail-form" onsubmit="submitComplaint(event)"> <!-- Handle form submission -->
                            <div class="mb-4">
                                <label class="block mb-1 text-purple-700">Your Complaint</label>
                                <textarea placeholder="Write your complaint here..." class="textarea textarea-bordered w-full border-purple-700 h-32" required></textarea>
                            </div>
