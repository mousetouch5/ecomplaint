    ...
    <div class="flex h-screen">
            ...
            <div class="modal-box">
                ...
                <form method="POST" action="{{ route('feedback.store') }}">
                    ...
                    <div class="text-right">
                        <label for="feedbackModal"
                            class="btn bg-gray-500 text-white px-4 py-2 rounded mr-2">Cancel</label>
            ...
            <div class="flex items-center justify-center min-h-screen">
                <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
                    ...
                    <form action="{{ route('schedules.store') }}" method="POST">
                        ...
                        <input type="date" name="date" class="border border-gray-300 rounded-lg p-2 w-full mb-4"
                            required>
        ...
        <div class="modal" id="complaint-modal">
            <div class="modal-box border-2 border-purple-700">
                ...
                <form id="complaint-info-form" onsubmit="event.preventDefault(); openComplaintDetailModal();"
                    method="POST">
                    @csrf
                    <!-- Input fields -->
                    <div class="mb-4">
